...
export function getHardwareKeyring (
  ...
  onAuthorized?: (showAuthorizeDevice: boolean) => void
...
export function getLedgerSolanaHardwareKeyring (onAuthorized?: (showAuthorizeDevice: boolean) => void): SolanaLedgerBridgeKeyring {
