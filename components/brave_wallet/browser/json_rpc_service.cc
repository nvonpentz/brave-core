...
void JsonRpcService::OnGetERC721TokenUri(
  ...
  // We support IPFS, HTTPS, and data URIs.
...
void JsonRpcService::OnGetERC721MetadataPayload(
  ...
  VLOG(0) << "JsonRpcService::OnGetERC721MetadataPayload Body is " << body;
  // TODO(nvonpentz): Add JSON validation when
  // https://github.com/brave/brave-core/pull/12685 is merged
