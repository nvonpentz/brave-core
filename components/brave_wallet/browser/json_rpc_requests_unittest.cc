...
#include "brave/components/brave_wallet/browser/json_rpc_requests.h"
...
TEST(JsonRpcRequestsUnitTest, eth_getStorageAt) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getTransactionCount) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getBlockTransactionCountByHash) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getBlockTransactionCountByNumber) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getUncleCountByBlockHash) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getCode) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_sign) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_signTransaction) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_sendTransaction) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_sendRawTransaction) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_call) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_estimateGas) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getBlockByHash) {
  ASSERT_EQ(
      eth_getBlockByHash(
...
TEST(JsonRpcRequestsUnitTest, eth_getBlockByNumber) {
  ASSERT_EQ(
      eth_getBlockByNumber("0x1b4", true),
      R"({"id":1,"jsonrpc":"2.0","method":"eth_getBlockByNumber","params":["0x1b4",true]})");  // NOLINT
}

TEST(JsonRpcRequestsUnitTest, eth_getTransactionByHash) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getTransactionByBlockHashAndIndex) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getTransactionByBlockNumberAndIndex) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getTransactionReceipt) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getUncleByBlockHashAndIndex) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getUncleByBlockNumberAndIndex) {
  ASSERT_EQ(
...
TEST(JsonRpcRequestsUnitTest, eth_getCompilers) {
  ASSERT_EQ(
      eth_getCompilers(),
      R"({"id":1,"jsonrpc":"2.0","method":"eth_getCompilers","params":[]})");  // NOLINT
}

TEST(JsonRpcRequestsUnitTest, eth_compileSolidity) {
  ASSERT_EQ(
