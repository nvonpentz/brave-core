...
TEST_F(SolanaTxManagerUnitTest, DropTxWithInvalidBlockhash) {
  ...
  SetInterceptor(latest_blockhash2_, last_valid_block_height2_, tx_hash2_, R"({
      "jsonrpc":"2.0","id":1,
      "result": {
        "context":{"slot":123065869},
        "value": 5000
...
TEST_F(SolanaTxManagerUnitTest, RebroadcastTransaction) {
  ...
  send_transaction_calls_ = 0;
  SetInterceptor(latest_blockhash1_, last_valid_block_height1_, "", R"({
      "jsonrpc":"2.0","id":1,
      "result": {
        "context":{"slot":123065869},
        "value": 5000
  ...
  SetInterceptor(latest_blockhash2_, last_valid_block_height2_, "", R"({
      "jsonrpc":"2.0","id":1,
      "result": {
        "context":{"slot":123065869},
        "value": 5000
