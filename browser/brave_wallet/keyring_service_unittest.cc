...
//   // AddAccount
//   // Mock an eth_getLogs response that includes logs for WETH transfers to
//   the
...
//   // AddHardwareAccounts
//   // Mock an eth_getLogs response that includes logs for USDC transfers to
//   the
...
//   base::RunLoop().RunUntilIdle();
//   account_infos =
//   service.GetAccountInfosForKeyring(mojom::kDefaultKeyringId); user_assets =
